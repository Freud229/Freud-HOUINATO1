...
function normalizeState(data) {
  ...
  return {
    ...
    shop: data.shop || {},
    transferDraft: Array.isArray(data.transferDraft) ? data.transferDraft : [],
    transfers: Array.isArray(data.transfers) ? data.transfers : [],
    hiddenInvoiceTickets: Array.isArray(data.hiddenInvoiceTickets) ? data.hiddenInvoiceTickets : [],
